        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-3 ms-3">
                    <h3 class="nama-kue p-1">Milky Cookie</h3>
                    <!-- <table> -->
                    <tr>
                            <td>
                                <h5  class="fst-italic" style="padding-top: 0cm;">Rp. 130.000</h5><br>
                            </td>
                            <!-- <form method="POST"> -->
                    ...
                    <span>Milky Cookie is the best seller of cookies category in our shop. By the combination of
                          chocolate, vanilla, and milk, you will get a super creamy and sensation
                          to boost your day.</span>
                    </div>
                </div>
