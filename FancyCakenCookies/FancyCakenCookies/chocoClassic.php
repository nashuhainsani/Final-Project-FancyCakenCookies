            ...
            <div class="row">
                <div class="col-3">
                    ...
                    <div class="list-group list-group-flush">
                        <h5><a href="" class="list-group-item text-white">Birthday</a></h3>
                ...
                <div class="col-3 ms-3">
                    <h3 class="nama-kue p-1">Chocolate Classic</h3>
                    <!-- <table> -->
                    <tr>
                            <td>
                                <h5  class="fst-italic" style="padding-top: 0cm;">Rp. 350.000</h5><br>
                            </td>
                            <!-- <form method="POST"> -->
                    ...
                    <span>Chocolate Classic is one of our best dessert and best seller
                        in our shop with combination of dark chocolate and very moisty mocca that it's 
                        perfect  for  you who are addict to an elegance taste.</span>
                    </div>
                </div>
