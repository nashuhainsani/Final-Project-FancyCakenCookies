            ...
            <div class="row">
                <div class="col-3">
                    ...
                    <div class="list-group list-group-flush">
                        <h5><a href="" class="list-group-item text-white">Cupcakes</a></h3>
                ...
                <div class="col-3 ms-3">
                    <h3 class="nama-kue p-1">Strawberry Moist</h3>
                    <!-- <table> -->
                        <tr>
                            <td>
                                <h5  class="fst-italic" style="padding-top: 0cm;">Rp. 100.000</h5><br>
                            </td>
                            <!-- <form method="POST"> -->
                    ...
                    <span>Strawberry Moist is the best pick for you who
                        are pretty and sweet. The moist of vanilla cream with a fresh strawberry are 
                        perfect to lightin up your day.</span>
                    </div>
                </div>
