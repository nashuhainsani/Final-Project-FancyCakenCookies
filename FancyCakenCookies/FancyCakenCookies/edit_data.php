...
<h5 class="text-white text-center">ID: <?php echo $d['id']; ?></h5><br><hr>
<input style="margin-bottom:10px;" type="text" name="nama" value="<?php echo $d['Name']; ?>"><br>
<input style="margin-bottom:10px;" type="text" name="price" value="<?php echo $d['Price']; ?>"><br>
<input style="margin-bottom:10px;" type="text" name="uom" value="<?php echo $d['UOM']; ?>"><br>
<input style="margin-bottom:10px;" type="text" name="quantity" value="<?php echo $d['Quantity']; ?>"><br>
