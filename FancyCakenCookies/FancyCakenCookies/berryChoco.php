...
<body>
    ...
    <!-- shop category -->
    <div class="shop container-fluid-deskrip text-white">
        <div class="container">
            <div class="row">
                <div class="col-3">
                    <div>
                    ...
                    <div class="list-group list-group-flush">
                        <h5><a href="" class="list-group-item text-white">Brownies</a></h3>
                        <a href="chocoClassic.php" class="list-group-item mb-3">Birthday</a>
                        <a href="chocoCrumble.php" class="list-group-item mb-3">Slice Cake</a>
                ...
                <div class="col-3 ms-3">
                    <h3 class="nama-kue p-1">Berry Choco Brownies</h3>
                    <!-- <table> -->
                    <tr>
                            <td>
                                <h5  class="fst-italic" style="padding-top: 0cm;">Rp. 365.000</h5><br>
                            </td>
                            <!-- <form method="POST"> -->
                    ...
                    <span>Berry Choco Brownies is one of our best dessert and best seller
                        in our shop with combination cream choco cream crumble and  fresh berry it's 
                        perfect  for  you who like fresh and sweet bluberries.</span>
                    </div>
                </div>
