            ...
            <div class="row">
                <div class="col-3">
                    ...
                    <div class="list-group list-group-flush">
                        <h5><a href="" class="list-group-item text-white">Cookies</a></h3>
                ...
                <div class="col-3 ms-3">
                    <h3 class="nama-kue p-1">Double Choco Cookie</h3>
                    <!-- <table> -->
                    <tr>
                            <td>
                                <h5  class="fst-italic" style="padding-top: 0cm;">Rp. 125.000</h5><br>
                            </td>
                            <!-- <form method="POST"> -->
                    ...
                    <span>Double Choco Cookie never fail to keep your mood up.
                        By the combination between two different high quality Chocolate
                        make them taste good.</span>
                    </div>
                </div>
